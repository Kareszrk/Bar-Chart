...
--
-- Gép: localhost
-- Létrehozás ideje: 2021. Nov 14. 13:06
...
CREATE TABLE `orszagok` (
  `orszag` varchar(27) CHARACTER SET latin2 COLLATE latin2_hungarian_ci NOT NULL DEFAULT '',
  `fovaros` varchar(19) CHARACTER SET latin2 COLLATE latin2_hungarian_ci NOT NULL DEFAULT '',
  `foldr_hely` varchar(37) CHARACTER SET latin2 COLLATE latin2_hungarian_ci NOT NULL DEFAULT '',
  `terulet` decimal(11,2) NOT NULL DEFAULT '0.00',
  `allamforma` varchar(30) CHARACTER SET latin2 COLLATE latin2_hungarian_ci NOT NULL DEFAULT '',
  `nepesseg` int NOT NULL DEFAULT '0',
  `nep_fovaros` int NOT NULL DEFAULT '0',
  `autojel` char(3) CHARACTER SET latin2 COLLATE latin2_hungarian_ci NOT NULL DEFAULT '',
  `country` varchar(31) CHARACTER SET latin2 COLLATE latin2_hungarian_ci NOT NULL DEFAULT '',
  `capital` varchar(19) CHARACTER SET latin2 COLLATE latin2_hungarian_ci NOT NULL DEFAULT '',
  `penznem` varchar(20) CHARACTER SET latin2 COLLATE latin2_hungarian_ci NOT NULL DEFAULT '',
  `penzjel` char(3) CHARACTER SET latin2 COLLATE latin2_hungarian_ci NOT NULL DEFAULT '',
  `valtopenz` varchar(18) CHARACTER SET latin2 COLLATE latin2_hungarian_ci NOT NULL DEFAULT '',
...
INSERT INTO `orszagok` (`orszag`, `fovaros`, `foldr_hely`, `terulet`, `allamforma`, `nepesseg`, `nep_fovaros`, `autojel`, `country`, `capital`, `penznem`, `penzjel`, `valtopenz`, `telefon`, `gdp`, `kat`) VALUES
